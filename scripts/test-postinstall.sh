...
echo "======================================"
echo "Testing QASpec Postinstall Script"
echo "======================================"
echo ""

# Save original environment
ORIGINAL_CI="${CI:-}"
ORIGINAL_QASPEC_NO_COMPLETIONS="${QASPEC_NO_COMPLETIONS:-}"

# Test 1: Normal install
echo "Test 1: Normal install (should print tip about completions)"
echo "--------------------------------------"
unset CI
unset QASPEC_NO_COMPLETIONS
...
echo "Test 3: QASPEC_NO_COMPLETIONS=1 (should skip silently)"
echo "--------------------------------------"
unset CI
export QASPEC_NO_COMPLETIONS=1
node scripts/postinstall.js
...
if [ -n "$ORIGINAL_QASPEC_NO_COMPLETIONS" ]; then
  export QASPEC_NO_COMPLETIONS="$ORIGINAL_QASPEC_NO_COMPLETIONS"
else
  unset QASPEC_NO_COMPLETIONS
fi
