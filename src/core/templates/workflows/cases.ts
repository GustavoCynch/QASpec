...
5. Read \`qaspec/references/tcms_case_rules.md\`.
...
10. Format cases: \`## Suite: <name>\` then per case \`- [ ] N.N Observable title\`, then **Preconditions** and **Steps** (Action + Expected table) indented below the checkbox line per \`templates/testcases.md\` and \`tcms_case_rules.md\`.
...
12. End with an approval halt covering the case list. Do NOT create or update \`specs/**/*.md\` in this step. Do NOT publish to your TCMS.
