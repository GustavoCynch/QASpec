...
PRs are test targets, not ground truth.`,
    ...
    rules: {
      ...
      'test-cases': [
        'Read analysis.md in full before PR diff; analysis.md wins when it conflicts with diff or current code',
        ...
        'Build preconditions and steps from analysis.md, diff, requirements, qaspec/specs, and observable UI/API from sources — do not invent vague flows',
