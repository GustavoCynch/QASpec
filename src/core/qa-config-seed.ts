...
PRs are test targets, not ground truth.`,
    ...
    rules: {
      ...
      apply: [
        ...
        'Per case: MCP create → mark each published case - [x] in testcases.md immediately after the successful create call; no local Qase IDs are recorded',
        'On re-run: reconcile unchecked cases against Qase by title before creating — never blind-create; cases already present in Qase are marked - [x] without a duplicate create call',
      ],
    },
  };
}
